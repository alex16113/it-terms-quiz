...
const bonusQuestions = [
  {
    ...
    emoji: '⭐',
    topic: 'Фуллстек',
    question: 'Разработчик, который умеет делать и фронтенд, и бэкенд проекта?',
    answer: 'Фуллстек',
    acceptableAnswers: ['фуллстек', 'fullstack', 'full-stack', 'фулстак'],
    isBonus: true
  },
  {
    id: 102,
  ...
  },
  {
    ...
    emoji: '⭐',
    topic: 'CI/CD',
    question: 'Что такое CI/CD (Непрерывная интеграция и доставка)?',
    options: [
      'Язык программирования для серверов',
      'Процесс переписывания всего кода',
      'Автоматический запуск тестов и деплой кода при каждом коммите',
      'Настройка дизайна базы данных'
    ],
    correct: 2,
    isBonus: true
  },
  ...
  },
  {
    ...
    options: [
      'Конфликт разработчиков на встрече',
      'Ситуация, когда два человека изменили одну и ту же строчку кода',
      'Ошибка при оплате сервера',
      'Вирус в репозитории'
    ],
    correct: 1,
    isBonus: true
